...
lines = [
    ...
    [("      ✓ ", GREEN), ("163 to 480 words readable per page without JavaScript", FG)],
    [("", FG)],
    [("  ! ", YELLOW), ("TRUSTWORTHY     ", BOLD), ("room to improve", YELLOW)],
    [("      ! ", YELLOW), ("Third-party app error visible in served markup on 7 of 8 pages", FG)],
    [("      ✓ ", GREEN), ("Refund, shipping, privacy and terms policies all published", FG)],
    [("", FG)],
    [("  ✓ ", GREEN), ("ACTIONABLE      ", BOLD), ("looking good", GREEN)],
    [("      ✓ ", GREEN), ("Storefront MCP endpoint live; UCP manifest published", FG)],
    [("", FG)],
    [("  10 findings · 1 fail · 4 warn · 5 pass", DIM)],
